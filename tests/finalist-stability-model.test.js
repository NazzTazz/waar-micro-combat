...
vm.runInThisContext(fs.readFileSync(path.join(__dirname, '../resources/finalist-stability-model.js'), 'utf8'));
...
console.log('finalist-stability-model: ok');
