...
## Reprise courante — campagne optimisée, 26 septembre 2026

- **Décisions PO / sources :** ATT-04/07/08/11/13/14 ; campagne complète du 25 septembre, audit météo, protocole VPS, issue #24, B1 #25/#26 et [prototype](benchmarks/2026-09-26-fast-impact-prototype.md). Le PO demande le moteur rapide, une météo commune aux deux camps, des effets météo non configurables dans la soufflerie et 20 rounds maximum. Le seuil de blessure continue à intervenir dans les prisonniers. Le [nouvel inventaire](../experiments/campagne-coeur-optimized/README.md) réutilise les plans et le profil source, les graines, le CLI de reprise et les exports ; il écarte les variations météo asymétriques et les 80 plans de facteurs météo. Échec à éviter : attribuer les anciens résultats au nouveau moteur ou lancer la campagne lourde sur le PC.
- **Branche / fait :** `campaign/optimized-shared-weather`, issue de `7f1fecda6e9a58a9fe128ad69dad940f8cc7d397`, non fusionnée. 79 plans dérivés avec SHA de source et de destination ; prévisualisation de 22 544 000 combats prévus. Le runner demande et vérifie le protocole optimisé, et les nouveaux plans imposent météo commune, effets constants et plafond 20. Contrôles locaux : Composer strict/install, PHP 163 tests / 24 138 assertions, JavaScript et smoke 2 400 combats verts ; Rust optimisé et son contrôle statistique multi-tailles verts. Un lot local D1 de 200 combats a réussi. Les anciens résultats et fichiers non suivis préexistants restent locaux et inchangés.
- **VPS Strasbourg, 26 septembre 15:58–18:23 UTC :** accès via la session PuTTY locale documentée dans `../.vps` (fichier personnel non publié). Contexte dédié SHA-256 `860aca0511f49ebb100c805a10fea4c797f0ed8d5a54f58ef298eab011eac11c`, image dédiée `sha256:a580e426c9fc2c10f5b8c9b722d92336e441f9052bfce43c45ea132ee0a16803`. Deux shards à 1 vCPU / 600 Mio, sans réseau, ont achevé 40 et 39 plans. Audit final : 22 544 000 combats, 79 manifestes complets, 79 exports, zéro erreur, un même SHA binaire `6474fe3428ba698f53fdf90ba26471f62385978c749b24daf599fbd3aecd0f1b` et un même SHA de diff suivi `ba691ba042bcedd9a61a36f5969026bc95859dccdc7e47f24e6bce35673baf2f`. Résultats et logs conservés sur le VPS ; aucun worker actif, image de campagne retirée. Les services web sont restés actifs.
- **Reste / reprise :** analyser les effets de gameplay et le coût de chaque paramètre avant arbitrage ; qualifier davantage la physique du sampler et rendre l'éditeur météo de la soufflerie non modifiable (l'interface actuelle expose encore ses coefficients). Aucun résultat de campagne ni moteur n'est encore accepté par le PO. La PR #27 a fusionné le plafond 10 frappes sur `main` après 3/3 jobs CI verts ; cette campagne épinglée inclut des valeurs de recherche supérieures à 10 et sa branche ne doit pas être fusionnée telle quelle dans ce `main`.

## Reprise historique — prototype d'impacts, 26 septembre 2026
...
- **Vérification et reste :** parités exactes des résultats comparables et contrôle de partition exact ; après contre-mesure, 161 tests PHP / 24 132 assertions, suite JavaScript, smoke 2 400 combats, Rust normal et diagnostic passants. PR #26 à relire ; le gain d'une optimisation du sampler reste non mesuré. Fichiers non suivis préexistants et scripts locaux `reports/issue25-b1/` conservés hors de la livraison. Aucun déploiement ou contrôle VPS, aucune acceptation PO.
