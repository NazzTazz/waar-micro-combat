...
- **Vérification et reste :** parités exactes des résultats comparables et contrôle de partition exact ; 161 tests PHP / 24 132 assertions, suite JavaScript, smoke 2 400 combats, Rust normal et diagnostic passants. PR #26 à relire ; examiner les pistes classées dans le rapport avant toute tranche d'optimisation ou de progressif. Fichiers non suivis préexistants et scripts locaux `reports/issue25-b1/` conservés hors de la livraison. Aucun déploiement ou contrôle VPS, aucune acceptation PO.
