...
- [Export corrigé pour la recherche](../var/waar-micro-combat/objectives/20260909-po-design-01-canonical/acceptance-zones.json) : livré, 32 zones activées et confirmées. Les 32 objets sont strictement identiques aux entrées survivants de l'original.
...
- [Éditeur corrigé](../var/waar-micro-combat/t26-canonical-objectives/report.html). Importer le JSON corrigé pour retrouver le design PO ; l'ancien export est également accepté et converti avec un message explicite.
