...
**Reprise courante :** branche `bench/issue-25-b1`, base `main` / `origin/main` `05ebe6f3f2c29c9faf80e28a2558ed60c13e130f`, commit B1 `7dc4e7f` et [PR brouillon #26](https://github.com/NazzTazz/waar-micro-combat/pull/26). B1 est une mesure et son outillage diagnostic, non une optimisation ni une acceptation PO. Relire la PR, puis examiner les pistes et le besoin de progressif avant une tranche de changement utilisateur. Les fichiers non suivis préexistants du checkout et les scripts locaux sous `reports/issue25-b1/` restent hors de la livraison.
