...
final readonly class CombatResult
{
    ...
    public function __construct(public CombatArmy $attackerArmy,public CombatArmy $defenderArmy,public array $rounds,public ?CombatSide $winner,
        public VictoryReason $reason,public CombatSnapshot $snapshot,public string $rulesetVersion,public PreparedCombatSide $attackerPrepared,
        public PreparedCombatSide $defenderPrepared,public array $decision,public string $replayHash){}
