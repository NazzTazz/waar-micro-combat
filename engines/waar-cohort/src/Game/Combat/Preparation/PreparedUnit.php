...
final readonly class PreparedUnit
{
    ...
    public function __construct(
        public UnitType $type, public float $attack, public float $structure, public int $cost,
        public float $baseAccuracy, public float $accuracySpread, public int $strikesPerAttack,
        public float $defendingEfficiency, public bool $capturable, public array $base, public array $effects,
    ) {}
