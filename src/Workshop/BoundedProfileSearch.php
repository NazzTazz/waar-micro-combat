...
final readonly class BoundedProfileSearch
{
    ...
    public function search(array $profile,array $zones,string $weather='neutral',int $baseSeed=314159,int $budget=8,int $iterations=100,array $bounds=[]):array
    {
        ...
        return ['schemaVersion'=>'waar-bounded-profile-search/0.1','referenceFingerprint'=>$reference->semanticFingerprint(),'referenceProfile'=>$reference->toArray(),'weather'=>$weather,'searchSeed'=>$baseSeed,'candidateBudget'=>$budget,'evaluated'=>count($candidates),'proposalLimit'=>80,'iterationsPerScenario'=>$iterations,'bounds'=>$bounds,'zones'=>$zones,'frozen'=>['costs'=>true,'capturable'=>true,'weather'=>true,'rounds'=>true,'randomSpread'=>true,'tieBreakPolicy'=>true,'lossCompressionPercent'=>true,'capturePercent'=>true],'selectionPerformed'=>false,'candidates'=>$candidates];
    }
